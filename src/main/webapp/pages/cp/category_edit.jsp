        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="col-sm-12 col-md-4 col-lg-6" style="padding-left: 0;">
                    <h4 style="padding-bottom: 7px; padding-top: 8px; margin-bottom: 0;"><i class="fa fa-pencil"></i>&nbsp;Редактирование категории</h4>
                </div>
                    ...
                    <div class="form-horizontal">
                        <div class="form-group">
                            <div class="col-sm-4">
                                ...
                                <input type="text" id="category-name" value="${category.name}" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-4">
