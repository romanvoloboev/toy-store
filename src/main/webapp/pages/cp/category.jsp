        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="pull-right">
                    <a href="<c:url value="/cp/new_category"/>" data-toggle="tooltip" class="btn btn-primary" data-original-title="Добавить категорию"><i class="fa fa-plus"></i></a>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td class="text-right"><a href="<c:url value="/cp/edit_category"/>" data-toggle="tooltip" class="btn btn-primary" data-original-title="Редактировать"><i class="fa fa-pencil"></i></a></td>
                                </tr>
                                <tr>
