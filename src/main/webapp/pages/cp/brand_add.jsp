        ...
        <div class="container-fluid">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-pencil"></i> Добавление производителя</h3>
                </div>
                    ...
                    <div class="form-horizontal">
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" placeholder="Введите название производителя" id="brand-name" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-1 control-label" for="brand-country">Страна</label>
                                <div class="col-sm-4">
                                    <input type="text" placeholder="Введите страну производителя" id="brand-country" class="form-control">
